    ...
    <el-dialog :visible.sync="addVisible" title="添加账户" width="40%">
      <div class="form">
        <div class="form-container">
          <el-row>
            <el-col :span="9"><div class="center-text">账户名 </div></el-col>
            <el-col :span="15">
              <el-input v-model="addForm.account_name" size="medium" placeholder="请填写账户名" maxlength="10" show-word-limit />
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="9"><div style="height: 16px" /></el-col>
            <el-col :span="15"><div class="note">支持中文英文数字，限制10字符</div></el-col>
          </el-row>
        </div>
        <div class="form-container">
          <el-row>
            <el-col :span="9"><div class="center-text">云厂商 </div></el-col>
            <el-col :span="15">
              <el-select v-model="addForm.provider" size="medium">
        ...
        <div class="form-container">
          <el-row>
            <el-col :span="9"><div class="center-text">{{ keyLabel }} </div></el-col>
            <el-col :span="13">
        ...
        <div class="form-container">
          <el-row>
            <el-col :span="9"><div class="center-text">{{ secretLabel }} </div></el-col>
            <el-col :span="15">
